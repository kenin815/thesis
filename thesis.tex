...
% Title Page
\renewcommand{\enTitle}{Query-by-example Spoken Term Detection  based on
Attention-based Neural Network}  %英文標題
\renewcommand{\zhTitle}{基於專注式類神經網路之依例查詢口述語彙偵測}  %中文標題
...
\chapter{基於遞迴類神經網路之依例查詢口述語彙偵測}
 \input{chapters/chapter3}
\chapter{基於專注式類神經網路之依例查詢口述語彙偵測}
  \input{chapters/chapter4}
\chapter{基於語音詞向量之依例查詢口述語彙偵測}
  \input{chapters/chapter5}
\chapter{基於專注式和語音詞向量之依例查詢口述語彙偵測}
