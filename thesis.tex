...
% Title Page
\renewcommand{\enTitle}{Spoken Term Detection Based On End-to-End ASR-FREE Attention Nerual Network }  %英文標題
\renewcommand{\zhTitle}{基於畫重點類神經網路之口語詞彙偵測}  %中文標題
...
\renewcommand{\oralDate}{106 年 6 月 xx 日}  %口試日期
